...
def findBestLassoCSV():
    ...
    for csv in csvList:
        ...
        lowAvgMAD = list(lassoDF[_configKeys.YVALUETICKER+"_Low_average_toggles"].values)[3]
        ...
        highAvgMAD = list(lassoDF[_configKeys.YVALUETICKER + "_High_average_toggles"].values)[3]
